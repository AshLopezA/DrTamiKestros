package com.my.group.drtamiproject.application.components.samplecomponent;

import com.my.group.drtamiproject.api.services.SampleService;
...
@Model(adaptables = Resource.class,
       resourceType = "my-kestros-project/components/content/sample-component")
